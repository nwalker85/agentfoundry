...
class SimplePMAgent:
    ...
    async def process_message(self, message: str) -> dict[str, Any]:
        ...
        try:
            ...
            response_messages.append(f"❌ Error: {e!s}")
    ...
    def _parse_message(self, message: str) -> dict[str, Any]:
        ...
        task = {"epic_title": None, "story_title": None, "priority": "P2", "description": None}

        # Extract epic
        epic_patterns = [r"(?:part of|in|under|for)(?: the)? ([A-Z][^.]*?) epic", r"epic[:\s]+([A-Z][^.]*?)(?:\.|,|$)"]
    ...
    def _build_issue_body(self, task: dict[str, Any], story_url: str | None) -> str:
