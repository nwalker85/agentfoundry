...
class SimplifiedPMAgent:
    ...
    async def process_message(self, message: str) -> dict[str, Any]:
        ...
        definition_of_done = ["Code reviewed and approved", "Tests written and passing", "Documentation updated"]
...
The story has been added to the backlog and the team can now pick it up!"""
            ...
            return {
                ...
                "story_created": {"url": story_url, "title": story_title, "epic": epic_title, "priority": priority},
                "issue_created": {"url": issue_url, "title": story_title},
            }

        except Exception as e:
            # Error response
            return {
                "response": f"I encountered an error: {e!s}. Let me try a simpler approach...",
                "status": "error",
                "state": "error",
                "error": str(e),
                "requires_clarification": False,
