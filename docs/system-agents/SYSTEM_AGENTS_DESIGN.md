...
Agent Foundry's core platform consists of **4 system agents** that provide
channel adaptation, orchestration, context management, and response coherence.
These are **platform code**, not customer-deployed agents.
...
**Why Critical:** Without coherence_agent:
