...
Based on WCAG 2.1 guidelines, usability best practices, and modern UI/UX standards, here are recommended improvements for the Agent Foundry platform.
...
**WCAG Criteria:** 2.1.1 (Keyboard), 2.4.1 (Bypass Blocks), 2.4.7 (Focus Visible)
...
{isLoading ? (
  <div className="grid grid-cols-3 gap-6">
    {Array(6).fill(0).map((_, i) => <AgentCardSkeleton key={i} />)}
  </div>
) : (
