...
**Version:** 0.9.0 (Phase 1 - Visual Graph Editor MVP) **Status:** MVP
...
Forge AI is a visual agent configuration tool that allows you to create, edit,
and deploy AI agents using an intuitive graph-based interface. Instead of
writing YAML by hand, you can drag-and-drop nodes to build agent workflows and
...
**Documentation:** `/docs/FORGE_AI_USER_GUIDE.md` **API Docs:**
http://localhost:8003/docs **Issues:** Report bugs via GitHub Issues
