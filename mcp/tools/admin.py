...
from agent.object_admin_agent import ObjectAdminAgent, ObjectAdminState, ObjectType
...
class ListObjectsRequest(BaseModel):
    ...
    organization_id: str | None = Field(None, description="Optional org filter")
    domain_id: str | None = Field(None, description="Optional domain filter")
    environment: str | None = Field(None, description="Optional environment filter (instances)")
