    ...
    `}>
      ...
      `}>
        <div className="flex items-center gap-2">
          ...
          `}>
            <svg className={`w-4 h-4 ${isUser ? 'text-white' : 'text-white dark:text-black'}`} viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            <p className={`text-sm font-semibold ${isUser ? 'text-white' : 'text-gray-900 dark:text-gray-100'}`}>
              Story Created
            </p>
            {data?.status && (
              <p className={`text-xs ${isUser ? 'text-blue-200' : 'text-gray-500 dark:text-gray-400'}`}>
                {data.status}
              </p>
            )}
          </div>
      ...
      <div className="px-4 py-3 space-y-3">
        ...
        {data?.title && (
          <div className="flex items-start gap-2">
            <FileText className={`w-4 h-4 mt-0.5 flex-shrink-0 ${isUser ? 'text-blue-200' : 'text-gray-400 dark:text-gray-500'}`} />
            <p className={`text-sm font-medium ${isUser ? 'text-white' : 'text-gray-900 dark:text-gray-100'}`}>
              {data.title}
            </p>
          </div>
        )}
