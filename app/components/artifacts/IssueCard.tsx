  ...
  return (
    <motion.div
      ...
      className={`
        ...
        ${isUser ? 'bg-blue-700/20 border border-blue-500' : 'bg-white border border-gray-200'}
        ...
        {data.url && (
          <a
            ...
            className={`
              ...
              ${isUser ? 'text-blue-200 hover:text-blue-100' : 'text-gray-700 hover:text-gray-900'}
              transition-colors
            `}
          >
            Open in GitHub
