...
export default function ProjectsPage() {
  return (
    <div className="p-6 space-y-6">
      ...
      <UnderConstruction message="Project management is under development. Creating and managing projects is not yet available." />

      {/* Search + Filter */}
      <div className="flex gap-3">
        <Input placeholder="Search projects..." className="flex-1 max-w-sm" />
            ...
            <TableRow>
              <TableCell colSpan={6} className="h-64">
                <div className="flex flex-col items-center justify-center text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-fg-0 mb-2">No projects yet</h3>
