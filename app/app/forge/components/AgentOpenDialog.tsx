    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>Select an agent to open in Forge</DialogDescription>
        </DialogHeader>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isCurrent ? 'border-blue-600 bg-blue-600/10' : 'border-border bg-bg-1'
                    )}
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-semibold text-fg-0 truncate">{agent.display_name}</h3>
                          {isCurrent && (
                        ...
                        <p className="text-sm text-fg-2 line-clamp-2">{agent.description}</p>
                      </div>
