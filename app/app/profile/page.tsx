      ...
      <div className="flex-1 overflow-auto">
        <div className="max-w-4xl mx-auto p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-fg-2">Manage your account information and preferences</p>
          </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                ...
                <div className="mb-8">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-xs text-fg-2 mt-1">JPG, PNG or GIF. Max size 2MB.</p>
                    </div>
                  </div>
                </div>
            ...
            <TabsContent value="preferences" className="space-y-6">
              ...
              <Card className="p-6">
                ...
                <p className="text-sm text-fg-2">More preferences coming soon...</p>
              </Card>
            </TabsContent>
          </Tabs>
        </div>
