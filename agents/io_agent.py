...
class IOAgent:
    ...
    def detect_channel(self, channel_hint: str | None = None, **metadata) -> Literal["chat", "voice", "api"]:
        """
    ...
    def normalize_input(self, user_input: str, channel: str, **metadata) -> str:
        """
    ...
    def format_output(self, response: str, channel: str, **metadata) -> str:
        """
        Format response for specific channel.
    ...
    async def process_message(
        self, user_message: str, session_id: str, user_id: str = "default_user", channel: str | None = None, **metadata
    ) -> str:
        """
        ...
        # Normalize input
        normalized_input = self.normalize_input(user_message, detected_channel, **metadata)
        ...
        try:
            ...
            formatted_response = self.format_output(response, detected_channel, **metadata)
    ...
    async def handle_chat_message(self, message: str, session_id: str) -> str:
        ...
        return await self.process_message(
            user_message=message, session_id=session_id, user_id=f"chat_user_{session_id}", channel="chat"
        )

    async def handle_voice_message(self, transcribed_text: str, session_id: str, room_name: str) -> str:
        """
